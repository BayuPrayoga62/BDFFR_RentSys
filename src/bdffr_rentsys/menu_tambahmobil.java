...
//        String namaKolom[] = {"id","nama_mobil","jenis","tahun", "warna", "nomor_kendaraan","jumlah", "harga", "status"};
//        rs=con.querySelect(namaKolom,"mobil");
//        tabelmobil.setModel(new resultsettable(rs));
//        
//    }
    private void loadTabel() {
//       String namaKolom[] = {"id","nama_mobil","jenis","tahun", "warna", "nomor_kendaraan","jumlah", "harga", "status"};
       String namaKolom[] = {"id","nama_mobil","jenis","tahun", "warna", "nomor_kendaraan", "harga", "status"};
       rs = con.querySelect(namaKolom, "mobil");
       
       try {
           if (rs != null && rs.next()) {
               // Set model tabel langsung tanpa menggunakan beforeFirst()
               tabelmobil.setModel(new resultsettable(rs));
           } else {
...
//                String kolom[] = {"nama_mobil","jenis","tahun","warna","nomor_kendaraan","jumlah", "harga", "status"};
                String kolom[] = {"nama_mobil","jenis","tahun","warna","nomor_kendaraan", "harga", "status"};
...
//                                 tf_jumlah.getText(),
                ...
                System.out.println( con.queryInsert("mobil",kolom,isi));
    ...
    private void initComponents() {
        ...
        cb_tahun = new javax.swing.JComboBox<String>();
        ...
        jLabel1.setText("BDFFR RentSys | Tambah Mobil");
        ...
        cb_tahun.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "2025", "2024", "2023", "2022", "2021", "2020", "2019", "2018", "2017", "2016", "2015", "2014", "2013", "2012", "2011", "2010" }));

        cb_status.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "tersedia", "dipinjam", "dikembalikan" }));
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        ...
                        .addComponent(tf_merk, javax.swing.GroupLayout.PREFERRED_SIZE, 187, javax.swing.GroupLayout.PREFERRED_SIZE))
                    ...
                    .addComponent(tf_sewa, javax.swing.GroupLayout.PREFERRED_SIZE, 163, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        .addComponent(tf_warna, javax.swing.GroupLayout.Alignment.LEADING)
                        .addComponent(cb_tahun, javax.swing.GroupLayout.Alignment.LEADING, 0, 102, Short.MAX_VALUE)))
        ...
        tabelmobil.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID Mobil", "Merk Mobil", "Tipe Mobil", "Tahun Produksi", "Warna", "Nomor Polisi", "Harga Sewa", "Status"
            }
        ));
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        ...
                        .addGroup(jPanel1Layout.createSequentialGroup()
                            ...
                            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                            .addComponent(tf_cari, javax.swing.GroupLayout.PREFERRED_SIZE, 139, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void tabelmobilMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelmobilMouseClicked
        ...
        tf_warna.setText(String.valueOf(tabelmobil.getValueAt(tabelmobil.getSelectedRow(),4)));
        tf_nopol.setText(String.valueOf(tabelmobil.getValueAt(tabelmobil.getSelectedRow(),5)));
        tf_sewa.setText(String.valueOf(tabelmobil.getValueAt(tabelmobil.getSelectedRow(),6)));
        cb_status.setSelectedItem(String.valueOf(tabelmobil.getValueAt(tabelmobil.getSelectedRow(),7)));
//        tf_jumlah.setText(String.valueOf(tabelmobil.getValueAt(tabelmobil.getSelectedRow(),8)));
...
//                                 tf_jumlah.getText(),
                                 tf_sewa.getText(),
                                 cb_status.getSelectedItem().toString()};
               con.queryUpdate("mobil", kolom, isi,"id='"
